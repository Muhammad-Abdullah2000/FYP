...
export default function DashProfile() {
    ...
    const uploadImage = async () => {
        ...
        uploadTask.on(
            ...
            (error) => {
                setImageFileUploadError('Could not upload the image (File must be less 2MB)');
    ...
    return (
        <div className='max-w-lg mx-auto p-3 w-full'>
            <h1 className='my-3 text-center font-semibold text-3xl'>Profile</h1>
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                <input type="file" accept='image/*' onChange={hangleImageChange} ref={filePickerRef} className='hidden' />
