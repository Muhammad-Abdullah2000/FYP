  ...
  return (
    <Navbar className='border-b-2'>
      ...
      <form action="" onSubmit={handleSubmit}>
        <TextInput type='text' placeholder='Search Blogs' rightIcon={AiOutlineSearch} className='hidden lg:inline' value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
      </form>
